...
app.get('/', (req, res)=>{
    res.render('index', {title:'RAC - Sistema de Ar Condicionado', style: "style/home.css"})
})
...
app.post('/env/renata', (req,res)=>{
    ...
    transporter1.sendMail({
        ...
        res.send("Erro, Tente novamente mais tarde ou troque o navegador utilizado (Recomenda-se o Google-Chrome)")
    })
})
